...
import ProductDetails from "../../../components/ResellerPanel/ProductDetails/ProductDetails";
import ProductInformation from "../../../components/ResellerPanel/ProductDetails/ProductInformation";
    ...
    const fetchProduct = async () => {
      try {
        ...
        const response = await axios.get(
          `${api_host}/seller_supplier_products/${id}/` 
        );
