...
//     onClick={() => handlePatch(item.id, false, "", "supplier")} // approve
//         >
...
//         (user) => user.request_for === "supplier"
//       );
    ...
    <tr key={item.id} className="border-b border-gray-200 hover:bg-gray-50">
      ...
      <td className="py-3 px-3 flex items-center space-x-2">
        <button
          ...
          onClick={() => handlePatch(item.id, false, "", "supplier")}
        >
          <MdCheckCircle className="text-sm" />
        </button>
        <button
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <Table columns={columns} data={usersData} renderRow={RenderUserDetailsRow} />
