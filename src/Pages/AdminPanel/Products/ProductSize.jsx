...
const ProductSize = () => {
  ...
  const fetchColors = async () => {
    try {
      // Dummy data for now
      const data = [
        { id: 1, name: "30", status: "active" },
        { id: 2, name: "X", status: "inactive" },
        { id: 3, name: "XL", status: "active" },
        { id: 4, name: "L", status: "inactive" },
      ];
      // If using backend:
      ...
      <div className="overflow-x-auto">
        <table className="w-full table-fixed border-collapse">
          <thead className="bg-gray-100 sticky top-0 z-10">
            <tr style={{ height: "70px" }}>
              <th className="w-16 px-4 py-2 text-left">SL</th>
              <th className="w-32 px-4 py-2 text-left">Size Name</th>
              <th className="w-24 px-4 py-2 text-left">Status</th>
              <th className="w-40 px-4 py-2 text-left">Action</th>
            </tr>
          </thead>
