...
const CreateOrEditSubCategory = ({ 
  ...
  const [formData, setFormData] = useState({
    ...
    subCategoryName: editedData?.subCategoryName || '',
      ...
      <div className="container mx-auto p-4 md:p-8">
        ...
        <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 md:mb-8 gap-4">
          ...
          <div className="flex gap-3 w-full sm:w-auto">
            ...
            <button
              onClick={() => navigate('/admin/products/sub-categories/manage')}
        ...
        <div className="bg-white p-4 md:p-8 rounded-xl shadow-lg">
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="sub-category-name">
                 Sub Category Name *
              </label>
              <input
...
export default CreateOrEditSubCategory;