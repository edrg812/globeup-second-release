...
const RenderContactDetailsRow = (item, index) => {
  ...
  return (
    <tr key={index} className="border-b border-gray-200 hover:bg-gray-50">
      ...
      <td className="py-3 px-3 flex items-center space-x-2">
        ...
        <Link 
          to={`/admin/settings/contact/edit/${1000}`}
...
const Contact = () => {
  ...
  const contactData = [
    { id: 1, phone:'+8809638365975', email:"support@globeup.com", status: 'Active' },
    ...
    <div className="bg-gray-50 font-sans" style={{ backgroundColor: '#f3e8ff' }}>
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-gray-800">Contact Manage</h1>
          <Link
            to="/admin/settings/contact/create"
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <Table
            columns={columns}
            data={contactData}
            renderRow={RenderContactDetailsRow}
          />
