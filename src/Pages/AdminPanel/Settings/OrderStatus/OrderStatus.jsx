...
const RenderOrderStatusDetailsRow = (item, index) => {
  ...
  return (
    <tr key={index} className="border-b border-gray-200 hover:bg-gray-50">
      ...
      <td className="py-3 px-3 flex items-center space-x-2">
        ...
        <Link
          to={`/admin/settings/order-status/edit/${1000}`}
...
const OrderStatus = () => {
  ...
  const orderData = [
    { id: 1, name:'কল রিসিভ করতেছেনা', status: 'Active' },
    { id: 2, name:'কাস্টমার ভুয়া', status: 'Active' },
    { id: 3, name:'Cancelled', status: 'Active' },
    { id: 4, name:'Completed', status: 'Active' },
    { id: 5, name:'In Courier', status: 'Active' },
    { id: 6, name:'	On Hold', status: 'Active' },
    { id: 7, name:'On The Way', status: 'Active' },
    { id: 8, name:'Processing', status: 'Active' },
    ...
    <div className="bg-gray-50 font-sans" style={{ backgroundColor: '#f3e8ff' }}>
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-gray-800">Order Status Manage</h1>
          <Link
            to="/admin/settings/order-status/create"
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <Table
            columns={columns}
            data={orderData}
            renderRow={RenderOrderStatusDetailsRow}
          />

          <div className="flex flex-col md:flex-row justify-between items-center mt-4 space-y-2 md:space-y-0">
            <span className="text-gray-600 text-sm">Showing 1 to {orderData.length} of {orderData.length} entries</span>
