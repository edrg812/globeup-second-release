...
const RenderShippingChargeDetailsRow = (item, index) => {
  
  return (
    <tr key={index} className="border-b border-gray-200 hover:bg-gray-50">
      <td className="py-3 px-3 align-middle">{index + 1}</td>
      <td className="py-3 px-3 align-middle">{item.areaName}</td>
      ...
      <td className="py-3 px-3 flex items-center space-x-2">
        ...
        <Link
          to={`/admin/settings/shipping-charge/edit/${1000}`}
...
const ShippingCharge = () => {
  ...
  const shippingData = [
    { id: 1, areaName:'সারা বাংলাদেশ ১২০ টাকা ডেলিভারি চার্জ', status: 'Active' },
    { id: 2, areaName:'ঢাকার ভিতরে ৮০ টাকা', status: 'Active' },
    { id: 3, areaName:'ঢাকার পার্শবর্তী এলাকা ১০০ টাকা', status: 'Active' },
    { id: 4, areaName:'ফ্রি ডেলিভারি', status: 'Active' },
    ...
    <div className="bg-gray-50 font-sans" style={{ backgroundColor: '#f3e8ff' }}>
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-gray-800">Shipping Charge Manage</h1>
          <Link
            to="/admin/settings/shipping-charge/create"
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <Table
            columns={columns}
            data={shippingData}
            renderRow={RenderShippingChargeDetailsRow}
          />

          <div className="flex flex-col md:flex-row justify-between items-center mt-4 space-y-2 md:space-y-0">
            <span className="text-gray-600 text-sm">Showing 1 to {shippingData.length} of {shippingData.length} entries</span>
